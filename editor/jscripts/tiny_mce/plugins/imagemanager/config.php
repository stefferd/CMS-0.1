<?php
	...
	$mcImageManagerConfig['thumbnail.jpeg_quality'] = 100; // quality of th image, note that this is not checked against when regenerating ths.
	...
	$mcImageManagerConfig['upload.extensions'] = "gif,jpg,jpeg,png,swf,mov,avi,mpg,mpeg,asf,flv";
	...
	$mcImageManagerConfig['SessionAuthenticator.logged_in_key'] = "LOGIN";
