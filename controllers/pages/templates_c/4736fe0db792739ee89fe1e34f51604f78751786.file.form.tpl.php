<?php /* Smarty version Smarty-3.1.8, created on 2012-07-08 20:50:27
...
pages/save/" method="post">
    ...
    <div class="field">
        <div class="question"><label for="text">Tekst</label></div>
        <div class="answer"><textarea id="text" name="text" placeholder="Tekstuele inhoud"></textarea></div>
    </div>
    <div class="field">
